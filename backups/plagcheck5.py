...
def find_matches(rp, sa, unique_words):
    ...
    return ['this is the', 'dummy list of', 'duplicated strings']

def remove_substrings(duplicates_list):
    # removes all the subsets of strings in a list, so
    # ['the big dog', 'the big', 'the'] becomes ['the big dog']
    duplicates = duplicates_list #temporary test solution
    return duplicates
